...
public class TestEnvironments {
  ...
  public static Map<String, String> csv() {
    ...
    Map<String, String> result = common();
    result.put(SpoolDirSourceConnectorConfig.INPUT_FILE_PATTERN_CONF, ".+\\.csv");
    result.put(SpoolDirSourceConnectorConfig.TOPIC_CONF, "csv-testing");
  ...
  public static Map<String, String> json() {
    Map<String, String> result = common();
    result.put(SpoolDirSourceConnectorConfig.INPUT_FILE_PATTERN_CONF, ".+\\.json");
    result.put(SpoolDirSourceConnectorConfig.TOPIC_CONF, "json-testing");
